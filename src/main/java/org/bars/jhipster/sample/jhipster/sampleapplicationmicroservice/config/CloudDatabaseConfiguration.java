...
@Configuration
@EnableMongoRepositories("org.bars.jhipster.sample.jhipster.sampleapplicationmicroservice.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("org.bars.jhipster.sample.jhipster.sampleapplicationmicroservice.config.dbmigrations");
